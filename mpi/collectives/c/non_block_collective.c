...
//    answer for part (a)
//    MPI_Ibcast(sendbuf, 2 * NTASKS, MPI_INT, 0, MPI_COMM_WORLD, &req);


//    answer for part (b)
//    MPI_Iscatter(sendbuf, 2, MPI_INT, recvbuf, 2, MPI_INT, 0, MPI_COMM_WORLD, &req);


/*    answer for part (c)
    int counts[] = {1, 1, 2, 4};
    int displs[] = {0, 1, 2, 4};
    MPI_Igatherv(sendbuf, counts[rank], MPI_INT, recvbuf, counts, displs, MPI_INT, 1, MPI_COMM_WORLD, &req);
*/


//    answer for part (d)
    MPI_Ialltoall(sendbuf, 2, MPI_INT, recvbuf, 2, MPI_INT, MPI_COMM_WORLD, &req);
